/* ------------------
 ...
 ---------------------- */
// from http://penguindreams.org/assignments
...
public class Client {
    ...
    //RTP variables:
    //----------------
    DatagramPacket rcvdPacket; //UDP packet received from the server
    ...
    public static void main(String argv[]) throws Exception {
        if (argv.length != 3) {
            System.out.println("Usage: java Client server_hostname RTSP_server_port video_file_name");
            System.exit(0);
        }
    ...
    class setupButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (state == INIT) {
                ...
                sendRTSPRequest("SETUP " + videoFileName + " RTSP/1.0");
    ...
    class timerListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                RTPPacket rtpPacket = new RTPPacket(rcvdPacket.getData(), rcvdPacket.getLength());
    ...
    //Send RTSP Request
    //------------------------------------
    private void sendRTSPRequest(String request_type) {
        try {
